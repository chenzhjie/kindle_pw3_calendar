...
IMAGE_URI="http://116.63.187.227/cron_kindle-wetter.png"

# folder of the root dir
ROOTDIR=/mnt/us/extensions/onlinescreensaver/bin
...
NOPOWERFILE=$ROOTDIR/nopower.png
